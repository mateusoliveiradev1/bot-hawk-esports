...
class AdvancedBadgesCommand extends BaseCommand {
  ...
  async handleProgress(interaction: ChatInputCommandInteraction, client: ExtendedClient): Promise<void> {
    ...
    await this.executeWithErrorHandling(interaction, client, async () => {
  ...
  async handleStreaks(interaction: ChatInputCommandInteraction, client: ExtendedClient): Promise<void> {
    const targetUser = interaction.options.getUser('user') || interaction.user;
    const advancedService = (client as any).advancedPUBGBadgesService as AdvancedPUBGBadgesService;
  ...
  async handleConsistency(interaction: ChatInputCommandInteraction, client: ExtendedClient): Promise<void> {
    const targetUser = interaction.options.getUser('user') || interaction.user;
    const advancedService = (client as any).advancedPUBGBadgesService as AdvancedPUBGBadgesService;
  ...
  async handleWeapons(interaction: ChatInputCommandInteraction, client: ExtendedClient): Promise<void> {
    const targetUser = interaction.options.getUser('user') || interaction.user;
    const advancedService = (client as any).advancedPUBGBadgesService as AdvancedPUBGBadgesService;
