...
import { Bot, Shield, Users, Activity, ArrowRight, AlertCircle, Home, Zap } from 'lucide-react';
...
const Login: React.FC = () => {
  ...
  const handleDiscordLogin = () => {
    ...
    const redirectUri = encodeURIComponent(
      import.meta.env.VITE_DISCORD_REDIRECT_URI || 'http://localhost:5173/login'
    );
            ...
            <div className='space-y-6'>
              ...
              >
                ...
                <p className='text-xl text-gray-600 mt-4'>
                  Acesse estatísticas em tempo real, gerencie usuários e configure seu bot de forma
                  intuitiva.
                </p>
              </motion.div>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Controle completo sobre membros',
                },
                {
                  icon: Activity,
                  title: 'Analytics',
                  desc: 'Estatísticas detalhadas em tempo real',
                },
