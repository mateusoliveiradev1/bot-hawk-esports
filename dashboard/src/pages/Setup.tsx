        ...
        <div className='text-center space-y-8'>
          ...
          <div className='space-y-4'>
            ...
            <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
              Em poucos passos, você terá o Hawk Esports funcionando perfeitamente no seu servidor
              Discord.
            </p>
          </div>
        ...
        <div className='space-y-8'>
          <div className='text-center'>
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Clique no botão abaixo para abrir o Discord e adicionar o Hawk Esports ao seu
              servidor.
            </p>
          </div>
          ...
          <div className='max-w-2xl mx-auto space-y-6'>
            ...
            <div className='bg-amber-50 border border-amber-200 rounded-xl p-6'>
              ...
              <p className='text-amber-700 text-sm'>
                Após executar o comando, você pode personalizar todas as configurações através deste
                dashboard.
              </p>
            </div>
          </div>
    ...
    },
    {
      ...
      content: (
        <div className='text-center space-y-8'>
          ...
          <div className='space-y-4'>
            <h2 className='text-4xl font-bold text-gray-900'>🎉 Configuração Concluída!</h2>
            <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
              O Hawk Esports está agora ativo no seu servidor e pronto para elevar a experiência da
              sua comunidade.
            </p>
          </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-left'>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-600'>
                    Ajuste o bot às necessidades do seu servidor
                  </p>
                </div>
              </div>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-600'>
                    Digite <code className='bg-gray-200 px-1 rounded text-xs'>/help</code> para ver
                    todos os comandos
                  </p>
                </div>
              </div>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-600'>
                    Defina canais para música, logs e boas-vindas
                  </p>
                </div>
              </div>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-600'>
                    Acompanhe o engajamento através do dashboard
                  </p>
                </div>
              </div>
            </div>
