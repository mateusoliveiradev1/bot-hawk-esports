...
import { TrendingUp, Users, Command, Server, Activity } from 'lucide-react';
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
        ...
        <div className='card'>
          <h3 className='text-lg font-semibold text-secondary-900 mb-4'>Atividade Diária</h3>
      ...
      <div className='grid grid-cols-1 gap-6 lg:grid-cols-3'>
        {/* Command Categories */}
        <div className='card'>
          <h3 className='text-lg font-semibold text-secondary-900 mb-4'>Categorias de Comandos</h3>
          ...
          <div className='mt-4 space-y-2'>
            {commandCategories.map(category => (
              <div key={category.name} className='flex items-center justify-between'>
                ...
                <span className='text-sm font-medium text-secondary-900'>{category.value}%</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Top Commands */}
        <div className='card'>
          <h3 className='text-lg font-semibold text-secondary-900 mb-4'>Comandos Mais Usados</h3>
          <ResponsiveContainer width='100%' height={250}>
        ...
        {/* Growth Trend */}
        <div className='card'>
          <h3 className='text-lg font-semibold text-secondary-900 mb-4'>Crescimento (6 meses)</h3>
          <ResponsiveContainer width='100%' height={250}>
      ...
      <div className='card'>
        <h3 className='text-lg font-semibold text-secondary-900 mb-4'>Estatísticas Detalhadas</h3>
            ...
            <tbody className='bg-white divide-y divide-secondary-200'>
              {dailyStats?.map((stat, index) => {
                ...
                const growthRate = prevStat
                  ? (((stat.users - prevStat.users) / prevStat.users) * 100).toFixed(1)
                  : '0.0';
                ...
                return (
                  <tr key={stat.date} className='hover:bg-secondary-50'>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap text-sm'>
                      <span
                        className={`${parseFloat(growthRate) >= 0 ? 'text-success-600' : 'text-error-600'}`}
                      >
