        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Transforme seu servidor Discord em uma experiência gaming completa com recursos avançados de música, estatísticas PUBG, rankings e muito mais.
            </p>
          </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${feature.color} opacity-10 rounded-full -mr-10 -mt-10`} />
              </Card>
            </motion.div>
          ))}
        </div>
      ...
      content: (
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-6 text-white">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <div className="bg-gray-700 rounded-lg p-3">
                    <p className="text-sm">🎵 Tocando agora: <strong>Imagine Dragons - Believer</strong></p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <div className="bg-gray-700 rounded-lg p-3">
                    <p className="text-sm">🏆 <strong>João#1234</strong> conquistou o badge <strong>"Chicken Dinner Master"</strong>!</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <div className="bg-gray-700 rounded-lg p-3">
                    <p className="text-sm">📊 Estatísticas PUBG atualizadas para <strong>PlayerPro</strong></p>
                    <div className="grid grid-cols-3 gap-4 mt-2 text-xs">
                      <div>K/D: <strong>2.34</strong></div>
                      <div>Wins: <strong>127</strong></div>
                      <div>Rank: <strong>Diamond</strong></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center">
            <p className="text-gray-600 mb-4">Esta é apenas uma pequena amostra do que o Hawk Esports pode fazer!</p>
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="text-center bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-8">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Junte-se a milhares de servidores</h3>
            <p className="text-gray-600 mb-6">Mais de 2.500 servidores já confiam no Hawk Esports para elevar sua experiência Discord</p>
      ...
      content: (
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Clique no botão abaixo para adicionar o Hawk Esports ao seu servidor Discord e começar a transformar sua comunidade.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                onClick={() => window.open('https://discord.com/api/oauth2/authorize?client_id=YOUR_BOT_ID&permissions=8&scope=bot%20applications.commands', '_blank')}
              >
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            ...
            <div className="space-y-2 text-left">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Execute <code className="bg-gray-200 px-2 py-1 rounded text-sm">/bootstrap</code> para configuração automática</span>
              </div>
              <div className="flex items-center space-x-3">
