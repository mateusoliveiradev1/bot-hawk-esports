      ...
      return (
        <div className='min-h-screen bg-slate-900 flex items-center justify-center'>
          <div className='text-center max-w-md mx-auto p-6'>
            ...
            <p className='text-slate-300 mb-4'>Você não tem permissão para acessar esta página.</p>
      ...
      return (
        <div className='min-h-screen bg-slate-900 flex items-center justify-center'>
          <div className='text-center max-w-md mx-auto p-6'>
            ...
            <p className='text-sm text-slate-400'>Cargos necessários: {requiredRoles.join(', ')}</p>
          </div>
        </div>
      );
    }
